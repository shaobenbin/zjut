...
@SSDomain(table = "zjut_organization_resource", condition = "sts<>'N'")
@SSId(generateType = "seq", seq = "zjut_app")
public class Zjut_organization_resourceDomain extends PersistentObject {
	@SSPrimaryKey
	private Long id;
	...
	@SSManyToOne(column = "resource_id", parameter = "resourceDomain.id")
	private Zjut_resourcesDomain resourceDomain;

	@SSManyToOne(column = "resource_type_id", parameter = "resourceTypeDomain.id")
	private Zjut_resource_typeDomain resourceTypeDomain;
	...
	public Zjut_resourcesDomain getResourceDomain() {
		return resourceDomain;
	}

	public void setResourceDomain(Zjut_resourcesDomain resourceDomain) {
	...
	public Zjut_resource_typeDomain getResourceTypeDomain() {
		return resourceTypeDomain;
	}

	public void setResourceTypeDomain(
			Zjut_resource_typeDomain resourceTypeDomain) {
