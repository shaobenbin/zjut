...
@SSDomain(table = "zjut_organization_video", condition = "sts<>'N'")
@SSId(generateType = "seq", seq = "zjut_app")
public class Zjut_organization_videoDomain extends PersistentObject {
	@SSPrimaryKey
	private Long id;
	...
	@SSManyToOne(column = "video_id", parameter = "videosDomain.id")
	private Zjut_videosDomain videosDomain;
	...
	public Zjut_videosDomain getVideosDomain() {
		return videosDomain;
	}

	public void setVideosDomain(Zjut_videosDomain videosDomain) {
