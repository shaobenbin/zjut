...
public class Bulletin extends DefaultAction {
	...
	public String detail() {
		...
		List<Zjut_bulletinDomain> enBulletinList = Zjut_bulletinService.instance.getEnBulletinList(organizationDomain.getName());
		if(enBulletinList!=null){
			bulletinList.addAll(enBulletinList);
		}
