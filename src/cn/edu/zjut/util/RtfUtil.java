...
import test.cn.edu.zjut.WordTest;
...
public class RtfUtil{
	...
	public void rgModel(String inputPath, String outPath, Map data) {
		...
		String sourname = "C:\\Users\\shao\\work\\document\\application.rtf";
...
//			targetcontent = replaceRTF(sourcecontent,"given_name","吊死扶伤");
//			targetcontent = replaceRTF(targetcontent,"family_name","sfsd");
	...
	public static void main(String[] args) {
		...
		targetname += ".rtf";
		RtfUtil oRTF = new RtfUtil();

		// *****************************************
		// 利用HashMap读取数据库中的数据
		Map map = ObjectFormat.object2Map(new ApplicationDegreeBean());
		// ******************************************
