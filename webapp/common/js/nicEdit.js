...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '${base}/common/js/nicEditorIcons.gif',
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	nicURI : '${base}/editor/filemanager/upload/simpleuploader',
/////ssweb/appfile/Image/2009/07/24/[B@1abcd5e-1248403246343.jpg
	addPane : function() {
		this.im = this.ne.selectedInstance.selElm().parentTag('IMG');
	...
	addForm : function() {
		...
		myDoc.write('<input name="NewFile" type="file" style="margin-top: 10px;" />');
		myDoc.write('<input name="Type" type="hidden" value="image" />');
		myDoc.write('</form>');
	...
	//	alert("startUpload");
	//	o.url = '/ssweb/appfile/Image/2009/07/24/[B@1abcd5e-1248403246343.jpg';
	//	alert(o.url);
		this.myForm.setStyle({display : 'none'});
		this.myStatus.setContent('<img src="${base}/js/ajax-loader.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
		this.myForm.submit();
...
function OnUploadCompleted(retVal,fileUrl,newName,errorMessage){
